...
Namespace MasterDetailExample
	Friend Class MergeProcessor
		...
		Private mainRichEdit As New RichEditDocumentServer()
		Private suppllierRichEdit As New RichEditDocumentServer()
		Private productRichEdit As New RichEditDocumentServer()
		Private ordersRichEdit As New RichEditDocumentServer()
		Private resultRichEdit As New RichEditDocumentServer()
